...
%%
load(['TBL5/TBL5_result/TreeLassoothertest5_p' num2str(pcut*100) '_' num2str(binnum) '_allpop_k' num2str(k) '_lambda' num2str(lambda) '_gamma' num2str(gamma) ...
...
hold off;
colorbar();
title(['k:' num2str(k) ', ratio:' num2str(ratio) ',binnum:' num2str(binnum) ' ,p:' num2str(pcut)]);


figure(2);
subplot(2,4,iii*2-1);
plot(Cov_sps);
title(['cov, binnum:' num2str(binnum) ' ,p:' num2str(pcut)]);
subplot(2,4,iii*2);
plot(Obj_sps(4:end,1));
title(['obj, binnum:' num2str(binnum) ' ,p:' num2str(pcut)]);
